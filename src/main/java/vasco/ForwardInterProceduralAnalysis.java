		...
		while (!worklist.isEmpty()) {
			...
			if (node != null) {
				...
				if (out.equals(prevOut) == false) {
					// Then addLoop successors to the work-list.
				...
				// path to the end of the method, so addLoop the NULL unit
				...
				// Exit value is the copyWithMerge of the OUTs of the tail nodes.
